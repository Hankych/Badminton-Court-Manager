...
export const matchResults = pgTable(
  "match_results",
  {
    ...
    slot1ProfileId: uuid("slot_1_profile_id").references(() => profiles.id, { onDelete: "set null" }),
    slot2ProfileId: uuid("slot_2_profile_id").references(() => profiles.id, { onDelete: "set null" }),
    slot3ProfileId: uuid("slot_3_profile_id").references(() => profiles.id, { onDelete: "set null" }),
    slot4ProfileId: uuid("slot_4_profile_id").references(() => profiles.id, { onDelete: "set null" }),
  },
  (t) => ({
